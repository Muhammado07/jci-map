        ...
        defaults = {
            ...
            sidebar: {
                ...
                selectSection: {
                    ...
                    difFiles: [["Dealers", "markers"], ["Branches", "diffmarkers"]],
                    fileTypes: "json"
                },
                searchBox: {
                    visible: false,
        ...
        setUpScriptBody: function (element, settings) {
            ...
            if (settings.sidebar.visible == true) {
                ...
                if (settings.sidebar.searchBox.visible == true || settings.sidebar.searchBox.search == true) {
                    sidebarBody.append("<div class='ct-googleMap--searchContainer'>" + "<input type='text' class='ct-googleMap--search' id='searchGmaps' placeholder='City'>" + "</div>");
        ...
        displayMarkers: function (constructor, element, map, bounds, settings) {
            ...
            if (settings.sidebar.selectSection.visible == true && settings.sidebar.visible == true) {
                ...
                if (settings.json == null) {
                    var singleMarker = [
                        { "lat": settings.marker.latlng[0], "lng": settings.marker.latlng[1], "title": settings.marker.title, "street": settings.marker.street, "region": settings.marker.region, "city": settings.marker.city, "landlineNo": settings.marker.landlineNo, "mobileno": settings.marker.mobileno, "email": settings.marker.email },
                    ];
            ...
            if (settings.infoBubble.visible == true) {
                var infoBubble = new InfoBubble({
                    ...
                    content: "<div class = 'ct-googleMap--InfoWindowBody' style='text-align: center;'>" +
                        ...
                        "<span>" + " - " + markerTable.street + " - " + markerTable.region + "</span>" +
                        "<span>" + " - " + markerTable.city + "</span>" +
                        "<span>" + " - " + markerTable.landlineNo + "</span>" +
                        "<span>" + " - " + markerTable.mobileno + "</span>" +
                        "<span>" + " - " + markerTable.email + "</span>" +
                        getDirectinButton +
                        "</div>",
